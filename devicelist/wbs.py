...
def wbsdevicelist(request):
  ...
  sqldata= t.sql_select("select CITY_NAME, IPADDMGM, NETWORKNAME, MAC, DEVICEMODELNAME, wlan0_fr, wlan0_ssid, wlan0_azimuth, wlan0_mac, wlan1_fr, wlan1_ssid, wlan1_azimuth, wlan1_mac, wlan2_fr, wlan2_ssid, wlan2_azimuth, wlan2_mac, geo_lat, geo_lon, serial  from guspk.WBS_Frecuency", "full")
