...
def main(data_key, t, error_free_ip):
	...
	adsl = ['AAM1212', 'IES-1248', 'AAM-1008', 'IES-5000', '7330 FD', '7302 FD', 'C300', 'C350MB', 'MA5603', 'MA5603T']
	...
	if data_key['model'] in fttb:
		...
		vrf = 'CORE'
		search_type = 'DSL'
		if data_key['model'] in ['C300', 'C350MB', 'MA5603', 'MA5603T']:
			search_type = 'MSAN'
		structura = 64
